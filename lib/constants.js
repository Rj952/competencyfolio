...
export const WEF_SKILLS = [
  { key: "cognitive", label: "Analytical & Critical Thinking", color: "#4f46e5", icon: "🧠",
  ...
  { key: "interpersonal", label: "Leadership & Collaboration", color: "#b45309", icon: "🤝",
    desc: "Social influence, teamwork, empathy, talent management" },
  { key: "digital", label: "Digital & Tech Literacy", color: "#0284c7", icon: "💻",
    desc: "Data management, AI literacy, cybersecurity awareness, digital fluency" },
  { key: "innovation", label: "Creative Thinking & Innovation", color: "#be123c", icon: "💡",
  ...
  { key: "communication", label: "Communication & Storytelling", color: "#0891b2", icon: "📢",
    desc: "Persuasion, negotiation, storytelling, active listening, writing" },
  { key: "global", label: "Global & Cross-Cultural", color: "#dc2626", icon: "🌏",
    desc: "Multilingual ability, cross-cultural understanding, global awareness" },
  { key: "learning", label: "Lifelong Learning & Metacognition", color: "#d97706", icon: "📚",
...
export const PROFICIENCY_LEVELS = [
  ...
  { value: 2, label: "Aware", color: "#93c5fd" },
  { value: 3, label: "Beginner", color: "#60a5fa" },
  { value: 4, label: "Intermediate", color: "#a78bfa" },
  { value: 5, label: "Advanced", color: "#f59e0b" },
  { value: 6, label: "Expert", color: "#10b981" },
];

// ─── CARE FRAMEWORK ───────────────────────────────────────────
export const CARE_PROMPTS = [
  { phase: "Consider", prompt: "What was the situation or challenge you faced?", icon: "🔍", color: "#4f46e5" },
  { phase: "Analyze", prompt: "What knowledge, skills, or strategies did you apply?", icon: "🧩", color: "#0891b2" },
...
export const ACRE_CRITERIA = [
  ...
  { key: "completeness", label: "Completeness", desc: "Does it fully demonstrate the claimed competency?", icon: "◉", color: "#4f46e5" },
  { key: "relevance", label: "Relevance", desc: "Is it directly relevant to the skill or competency?", icon: "◎", color: "#b45309" },
...
export const TABS = [
  ...
  { id: "plan", label: "5-Year Plan", icon: "▹" },
  { id: "endorse", label: "Endorsements", icon: "♦" },
  { id: "preview", label: "Portfolio", icon: "◻" },
];
