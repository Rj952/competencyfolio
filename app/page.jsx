...
export default function HomePage() {
  const features = [
    { icon: "⬡", title: "WEF 2030 Skills Map", desc: "10 core skill clusters aligned with the World Economic Forum's Future of Jobs framework" },
    { icon: "◆", title: "AI Readiness Index", desc: "8-competency taxonomy tracking your preparedness for the AI-transformed workplace" },
    { icon: "★", title: "Digital Badges", desc: "Earn visual credentials from Explorer to Master as you build evidence of competence" },
    { icon: "◌", title: "CARE + ACRE Reflections", desc: "Guided reflection using Consider-Analyze-Reflect-Evaluate with evidence quality scoring" },
    { icon: "◇", title: "Evidence Strength Scoring", desc: "Auto-calculated 5-point evidence quality assessment with ACRE evaluation overlay" },
    { icon: "♦", title: "Peer Endorsements", desc: "Collect third-party validation from supervisors, colleagues, and collaborators" },
    { icon: "▹", title: "5-Year Growth Plan", desc: "Map your professional trajectory with year-by-year milestones and status tracking" },
    { icon: "◎", title: "Gap Analysis", desc: "Visual radar charts and bar graphs revealing exactly where to focus development" },
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="max-w-6xl mx-auto px-8 pt-16 pb-24">
        <div className="max-w-3xl">
          ...
          <h1 className="heading-display text-5xl md:text-6xl text-stone-900 leading-[1.1] mb-6">
            ...
            <span className="text-brand-700">professional portfolio</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-8 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={s.num} className="text-center">
              <div className="heading-display text-3xl text-brand-400 mb-1">{s.num}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map(f => (
            <div key={f.title} className="card card-hover p-5">
              ...
              <h3 className="font-bold text-sm text-stone-900 mb-1.5">{f.title}</h3>
      ...
      <section className="bg-stone-100 py-16">
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card p-6">
              <h3 className="heading-display text-lg text-indigo-600 mb-2">ACRE Quality Lens</h3>
            ...
            <div className="card p-6">
              <h3 className="heading-display text-lg text-teal-600 mb-2">CRAFT Prompt Design</h3>
      ...
      <footer className="border-t border-stone-200 py-8">
        <div className="max-w-6xl mx-auto px-8 flex items-center justify-between text-xs text-stone-400">
          <div>
            <span className="heading-display text-sm text-stone-500">CompetencyFolio v3</span>
